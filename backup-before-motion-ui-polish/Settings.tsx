          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="glass-card p-8 bg-primary/5 border-primary/10">
              <div className="flex flex-col items-center text-center mb-6">
                ...
                <h2 className="text-xl font-bold text-primary-custom mb-1">Privacy &amp; Data Sandbox</h2>
              ...
              <div className="space-y-3">
                <a 
                  href="privacy.html"
                  className="w-full py-3 px-4 pastel-button flex items-center justify-center gap-2 shadow-sm font-bold text-xs uppercase"
                >
                ...
                <button 
                  ...
                  className="w-full py-3 px-4 pastel-button-rose flex items-center justify-center gap-2 font-bold text-xs uppercase"
                >
                ...
                <button 
                  ...
                  className="w-full py-3 px-4 pastel-button-secondary flex items-center justify-center gap-2 shadow-sm font-bold text-xs uppercase"
                >
